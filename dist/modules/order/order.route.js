...
categoryRoutes.post("/create", (0, authorization_middleware_1.default)(client_1.UserRole.admin), (0, fileUpload_middleware_1.default)("icon", "category", [
    ...
    "image/jpg",
    "image/png",
]), order_controller_1.default.createCategory);
categoryRoutes.get("/", (0, queryFeatures_middleware_1.default)("multiple"), order_controller_1.default.getCategories);
categoryRoutes.get("/:id", (0, queryFeatures_middleware_1.default)("single"), order_controller_1.default.getSingleCategory);
categoryRoutes.patch("/update/:id", (0, authorization_middleware_1.default)(client_1.UserRole.admin), (0, fileUpload_middleware_1.default)("icon", "category", [
    ...
    "image/jpg",
    "image/png",
]), order_controller_1.default.update);
categoryRoutes.delete("/delete/:id", (0, authorization_middleware_1.default)(client_1.UserRole.admin), order_controller_1.default.deleteCategory);
