...
const getCategories = (queryFeatures) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [result, count] = yield prismaClient_1.default.$transaction([prismaClient_1.default.category.findMany(query), prismaClient_1.default.category.count({ where: whereConditions })]);
    return {
        data: result,
        total: count,
    };
